...
export function Footer() {
  ...
  return (
    <>
      <footer className="mt-20 px-3 border-t border-border/40 pt-12 pb-6 relative group">
        <div className="flex flex-wrap items-center justify-between gap-12 mb-12">
          <div className="space-y-6">
            <div className="flex items-center gap-3">
              <Profile />
              <div className="flex flex-col gap-1">
                <span className="font-medium tracking-tighter text-base">
                  Akkal Dhami
                </span>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              {["Home", "Projects", "Experiments", "Contacts"].map(item => (
                <li key={item}>
                  <Link
